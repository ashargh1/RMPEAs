...
def PD(T,c): #PFP-A1,PFP-A2,PFP-A3,PFP-B2,PFP-Laves,PFP-Sigma,PSP with c=[0,0,0,0,0,0] for Ti Fe Al V Ni Nb Zr as binary
    ...
    if c[0] !=0 and c[7] !=0: #Ti-Mn has A1, A2, A3, and Laves phases
        In=np.loadtxt('BinPD/TiMn-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiMn-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiMn-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiMn-A2.txt')
        C1=In[0:199][:] #First region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])
        C1=In[199:][:] #Second region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])   
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
    ...
    if c[0] !=0 and c[8] !=0: #Ti-Co has A1, A3, and Laves phases
        In=np.loadtxt('BinPD/TiCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiCo-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiCo-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
        ...
        In=np.loadtxt('BinPD/TiCo-B2.txt')
        if Tpf>=1243.6: #Convex
            C1=In[0:608][:] #x<0.79
            B2x=np.append(B2x,IntSec(C1,Tpf)[0])
            C1=In[608:][:]
            B2x=np.append(B2x,IntSec(C1,Tpf)[0])
        else:
            B2x=np.append(B2x,IntSec(In,Tpf)[0])
        if np.shape(B2x)[0]==0:
            ...
            PFP_B2=np.abs(B2x[1]-B2x[0])
        elif np.shape(B2x)[0]==4:
            PFP_B2=np.abs(B2x[1]-B2x[0])+np.abs(B2x[3]-B2x[2])
    ...
    if c[1] !=0 and c[7] !=0: #Fe-Mn only has A1, A2, A3 and Laves phases
        In=np.loadtxt('BinPD/FeMn-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/FeMn-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/FeMn-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/FeMn-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
    ...
    if c[1] !=0 and c[8] !=0: #Fe-Co only has A1, B2, A3 and Laves phases
        In=np.loadtxt('BinPD/FeCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/FeCo-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/FeCo-B2.txt')
        B2x=np.append(B2x,IntSec(In,Tpf)[0])
        if np.shape(B2x)[0]==0:
            PFP_B2=0
        elif np.shape(B2x)[0]==2:
    ...
    if c[2] !=0 and c[7] !=0: #Al-Mn only has A1, A2, A3, and laves phases
        In=np.loadtxt('BinPD/AlMn-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/AlMn-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
        ...
        In=np.loadtxt('BinPD/AlMn-A1.txt')
        C1=In[0:658][:] #First region
        A1x=np.append(A1x,IntSec(C1,Tpf)[0])
        C1=In[658:][:] #Second region
        A1x=np.append(A1x,IntSec(C1,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/AlMn-A2.txt')
        C1=In[0:264][:] #First region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])
        C1=In[264:][:] #Second region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
    ...
    if c[2] !=0 and c[8] !=0: #Al-Co only has A1, and B2 phases
        In=np.loadtxt('BinPD/AlCo-B2.txt')
        B2x=np.append(B2x,IntSec(In,Tpf)[0])
        if np.shape(B2x)[0]==0:
            PFP_B2=0
        elif np.shape(B2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/AlCo-A1.txt')
        C1=In[0:686][:] #First region
        A1x=np.append(A1x,IntSec(C1,Tpf)[0])
        C1=In[686:][:] #Second region
        A1x=np.append(A1x,IntSec(C1,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
    ...
    if c[3] !=0 and c[7] !=0: #V-Mn only has A1, A2, A3 and Laves phases
        In=np.loadtxt('BinPD/VMn-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/VMn-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/VMn-Sigma.txt')
        Sigmax=np.append(Sigmax,IntSec(In,Tpf)[0])
        if np.shape(Sigmax)[0]==0:
            PFP_Sigma=0
        elif np.shape(Sigmax)[0]==2:
        ...
        In=np.loadtxt('BinPD/VMn-A2.txt')
        if Tpf>=1159 and Tpf<=1348: #Convex
            C1=In[0:207][:] #x<0.19
            A2x=np.append(A2x,IntSec(C1,Tpf)[0])
            C1=In[207:][:]
            A2x=np.append(A2x,IntSec(C1,Tpf)[0])
    ...
    if c[3] !=0 and c[8] !=0: #V-Co only has A1, A2, A3 and Sigma phases
        In=np.loadtxt('BinPD/VCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/VCo-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/VCo-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/VCo-Sigma.txt')
        Sigmax=np.append(Sigmax,IntSec(In,Tpf)[0])
        if np.shape(Sigmax)[0]==0:
            PFP_Sigma=0
        elif np.shape(Sigmax)[0]==2:
    ...
    if c[4] !=0 and c[7] !=0: #Ni-Mn only has A1, A2, A3 and B2 phase
        In=np.loadtxt('BinPD/NiMn-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NiMn-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NiMn-B2.txt')
        B2x=np.append(B2x,IntSec(In,Tpf)[0])
        if np.shape(B2x)[0]==0:
            PFP_B2=0
        elif np.shape(B2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NiMn-A1.txt')
        if Tpf>=507.5 and Tpf<=1183: #Convex
            C1=In[0:532][:] #x<0.48
            A1x=np.append(A1x,IntSec(C1,Tpf)[0])
            C1=In[532:][:]
            A1x=np.append(A1x,IntSec(C1,Tpf)[0])
        elif Tpf>=1294.5 and Tpf<=1439.5:
            C1=In[0:468][:] #x<0.39
            A1x=np.append(A1x,IntSec(C1,Tpf)[0])
            C1=In[468:][:]
            A1x=np.append(A1x,IntSec(C1,Tpf)[0])
    ...
    if c[4] !=0 and c[8] !=0: #Ni-Co only has A1, and A3 phase
        In=np.loadtxt('BinPD/NiCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NiCo-A3.txt')
        A3x=np.append(A3x,IntSec(In,Tpf)[0])
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
    ...
    if c[5] !=0 and c[7] !=0: #Nb-Mn only has A1, A2 and Laves phase
        In=np.loadtxt('BinPD/NbMn-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NbMn-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
        ...
        In=np.loadtxt('BinPD/NbMn-A2.txt')
        C1=In[0:133][:] #First region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])
        C1=In[133:][:] #Second region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])   
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
    ...
    if c[5] !=0 and c[8] !=0: #Nb-Co only has A1, A2 and Laves phase
        In=np.loadtxt('BinPD/NbCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NbCo-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/NbCo-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
    ...
    if c[6] !=0 and c[7] !=0: #Zr-Mn only has A1, A2 and Laves phase
        In=np.loadtxt('BinPD/ZrMn-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/ZrMn-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
        ...
        In=np.loadtxt('BinPD/ZrMn-A2.txt')
        C1=In[0:154][:] #First region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])
        C1=In[154:][:] #Second region
        A2x=np.append(A2x,IntSec(C1,Tpf)[0])   
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
    ...
    if c[6] !=0 and c[8] !=0: #Zr-Co only has A2 and Laves phase
        In=np.loadtxt('BinPD/ZrCo-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/ZrCo-Laves.txt')
        Lvx=np.append(Lvx,IntSec(In,Tpf)[0])
        if np.shape(Lvx)[0]==0:
            PFP_Lv=0
        elif np.shape(Lvx)[0]==2:
    ...
    if c[7] !=0 and c[8] !=0: #Mn-Co only has A1, A2 and A3 phase
        In=np.loadtxt('BinPD/MnCo-A1.txt')
        A1x=np.append(A1x,IntSec(In,Tpf)[0])
        if np.shape(A1x)[0]==0:
            PFP_A1=0
        elif np.shape(A1x)[0]==2:
        ...
        In=np.loadtxt('BinPD/MnCo-A2.txt')
        A2x=np.append(A2x,IntSec(In,Tpf)[0])
        if np.shape(A2x)[0]==0:
            PFP_A2=0
        elif np.shape(A2x)[0]==2:
        ...
        In=np.loadtxt('BinPD/MnCo-A3.txt')
        C1=In[0:303][:] #First region
        A3x=np.append(A3x,IntSec(C1,Tpf)[0])
        C1=In[303:][:] #Second region
        A3x=np.append(A3x,IntSec(C1,Tpf)[0])   
        if np.shape(A3x)[0]==0:
            PFP_A3=0
        elif np.shape(A3x)[0]==2:
